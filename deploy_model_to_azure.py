...
def retrieve_latest_development_model_from_unity_catalog():
    ...
    os.makedirs("./sim_rf_model", exist_ok=True)
    latest_model = mlflow.pyfunc.load_model(model_uri, dst_path="./sim_rf_model")
...
def deploy_model_to_workspace(model_uri):
    try:
        ...
        model_path = './sim_rf_model'

        # Registering the model
        model = Model.register(workspace=ws,
            model_name='sim_rf_model',
...
model_uri = retrieve_latest_development_model_from_unity_catalog()
